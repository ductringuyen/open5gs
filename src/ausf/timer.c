...
const char *ausf_timer_get_name(ausf_timer_e id)
{
    ...
    case AUSF_TIMER_DISCOVER_WAIT:
        return "AUSF_TIMER_DISCOVER_WAIT";
    default: 
       break;
    }
...
void ausf_timer_discover_wait_expire(void *data)
{
    sbi_timer_send_event(AUSF_TIMER_DISCOVER_WAIT, data);
}
