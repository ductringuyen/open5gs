...
void OpenAPI_pdu_session_created_data_free(OpenAPI_pdu_session_created_data_t *pdu_session_created_data)
{
    ...
    OpenAPI_pdu_session_type_free(pdu_session_created_data->pdu_session_type);
...
cJSON *OpenAPI_pdu_session_created_data_convertToJSON(OpenAPI_pdu_session_created_data_t *pdu_session_created_data)
{
    ...
    cJSON *pdu_session_type_local_JSON = OpenAPI_pdu_session_type_convertToJSON(pdu_session_created_data->pdu_session_type);
    ...
    if (pdu_session_created_data->enable_pause_charging >= 0) {
    ...
    if (pdu_session_created_data->always_on_granted >= 0) {
    ...
    if (pdu_session_created_data->ipv6_multi_homing_ind >= 0) {
    ...
    if (pdu_session_created_data->ma_accepted_ind >= 0) {
    ...
    if (pdu_session_created_data->nef_ext_buf_support_ind >= 0) {
...
OpenAPI_pdu_session_created_data_t *OpenAPI_pdu_session_created_data_parseFromJSON(cJSON *pdu_session_created_dataJSON)
{
    ...
    pdu_session_created_data_local_var = OpenAPI_pdu_session_created_data_create (
        pdu_session_type_local_nonprim,
        ...
        enable_pause_charging ? enable_pause_charging->valueint : -1,
        ...
        nef_ext_buf_support_ind ? nef_ext_buf_support_ind->valueint : -1
        );
