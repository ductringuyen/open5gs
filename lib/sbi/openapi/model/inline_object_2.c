    ...
    )
{
    ...
    inline_object_2_local_var->binary_mt_data = binary_mt_data;
...
void OpenAPI_inline_object_2_free(OpenAPI_inline_object_2_t *inline_object_2)
{
    ...
    OpenAPI_transfer_mt_data_req_data_free(inline_object_2->json_data);
    ogs_free(inline_object_2->binary_mt_data->data);
...
cJSON *OpenAPI_inline_object_2_convertToJSON(OpenAPI_inline_object_2_t *inline_object_2)
{
    ...
    if (inline_object_2->json_data) {
        cJSON *json_data_local_JSON = OpenAPI_transfer_mt_data_req_data_convertToJSON(inline_object_2->json_data);
    ...
    if (inline_object_2->binary_mt_data) {
        char* encoded_str_binary_mt_data = OpenAPI_base64encode(inline_object_2->binary_mt_data->data,inline_object_2->binary_mt_data->len);
        if (cJSON_AddStringToObject(item, "binaryMtData", encoded_str_binary_mt_data) == NULL) {
            ogs_error("OpenAPI_inline_object_2_convertToJSON() failed [binary_mt_data]");
            goto end;
        }
...
OpenAPI_inline_object_2_t *OpenAPI_inline_object_2_parseFromJSON(cJSON *inline_object_2JSON)
{
    ...
    cJSON *binary_mt_data = cJSON_GetObjectItemCaseSensitive(inline_object_2JSON, "binaryMtData");

    OpenAPI_binary_t* decoded_str_binary_mt_data = OpenAPI_malloc(sizeof(OpenAPI_binary_t));
    if (binary_mt_data) {
        if (!cJSON_IsString(binary_mt_data)) {
            ogs_error("OpenAPI_inline_object_2_parseFromJSON() failed [binary_mt_data]");
            goto end;
        }
