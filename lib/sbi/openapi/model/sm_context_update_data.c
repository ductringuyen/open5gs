...
void OpenAPI_sm_context_update_data_free(OpenAPI_sm_context_update_data_t *sm_context_update_data)
{
    ...
    OpenAPI_n2_sm_info_type_free(sm_context_update_data->n2_sm_info_type);
    ...
    OpenAPI_n2_sm_info_type_free(sm_context_update_data->n2_sm_info_type_ext1);
...
cJSON *OpenAPI_sm_context_update_data_convertToJSON(OpenAPI_sm_context_update_data_t *sm_context_update_data)
{
    ...
    if (sm_context_update_data->n2_sm_info_type) {
        cJSON *n2_sm_info_type_local_JSON = OpenAPI_n2_sm_info_type_convertToJSON(sm_context_update_data->n2_sm_info_type);
    ...
    if (sm_context_update_data->n2_sm_info_type_ext1) {
        cJSON *n2_sm_info_type_ext1_local_JSON = OpenAPI_n2_sm_info_type_convertToJSON(sm_context_update_data->n2_sm_info_type_ext1);
