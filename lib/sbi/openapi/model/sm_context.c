...
void OpenAPI_sm_context_free(OpenAPI_sm_context_t *sm_context)
{
    ...
    OpenAPI_pdu_session_type_free(sm_context->pdu_session_type);
...
cJSON *OpenAPI_sm_context_convertToJSON(OpenAPI_sm_context_t *sm_context)
{
    ...
    cJSON *pdu_session_type_local_JSON = OpenAPI_pdu_session_type_convertToJSON(sm_context->pdu_session_type);
    ...
    if (sm_context->enable_pause_charging >= 0) {
    ...
    if (sm_context->always_on_granted >= 0) {
    ...
    if (sm_context->forwarding_ind >= 0) {
    ...
    if (sm_context->nef_ext_buf_support_ind >= 0) {
...
OpenAPI_sm_context_t *OpenAPI_sm_context_parseFromJSON(cJSON *sm_contextJSON)
{
    ...
    sm_context_local_var = OpenAPI_sm_context_create (
        ...
        forwarding_ind ? forwarding_ind->valueint : -1,
