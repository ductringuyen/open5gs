...
OpenAPI_sm_context_create_data_t *OpenAPI_sm_context_create_data_create(
    ...
    OpenAPI_n2_sm_info_type_t *n2_sm_info_type,
    OpenAPI_ref_to_binary_data_t *n2_sm_info_ext1,
    OpenAPI_n2_sm_info_type_t *n2_sm_info_type_ext1,
    char *sm_context_ref,
...
void OpenAPI_sm_context_create_data_free(OpenAPI_sm_context_create_data_t *sm_context_create_data)
{
    ...
    OpenAPI_n2_sm_info_type_free(sm_context_create_data->n2_sm_info_type);
    OpenAPI_ref_to_binary_data_free(sm_context_create_data->n2_sm_info_ext1);
    OpenAPI_n2_sm_info_type_free(sm_context_create_data->n2_sm_info_type_ext1);
...
cJSON *OpenAPI_sm_context_create_data_convertToJSON(OpenAPI_sm_context_create_data_t *sm_context_create_data)
{
    ...
    if (sm_context_create_data->unauthenticated_supi >= 0) {
    ...
    if (sm_context_create_data->indirect_forwarding_flag >= 0) {
    ...
    if (sm_context_create_data->cp_ciot_enabled >= 0) {
    ...
    if (sm_context_create_data->cp_only_ind >= 0) {
    ...
    if (sm_context_create_data->invoke_nef >= 0) {
    ...
    if (sm_context_create_data->ma_request_ind >= 0) {
    ...
    if (sm_context_create_data->ma_nw_upgrade_ind >= 0) {
    ...
    if (sm_context_create_data->n2_sm_info_type) {
        cJSON *n2_sm_info_type_local_JSON = OpenAPI_n2_sm_info_type_convertToJSON(sm_context_create_data->n2_sm_info_type);
        if (n2_sm_info_type_local_JSON == NULL) {
            ogs_error("OpenAPI_sm_context_create_data_convertToJSON() failed [n2_sm_info_type]");
            goto end;
        }
        cJSON_AddItemToObject(item, "n2SmInfoType", n2_sm_info_type_local_JSON);
        if (item->child == NULL) {
            ogs_error("OpenAPI_sm_context_create_data_convertToJSON() failed [n2_sm_info_type]");
            goto end;
        }
    ...
    if (sm_context_create_data->n2_sm_info_type_ext1) {
        cJSON *n2_sm_info_type_ext1_local_JSON = OpenAPI_n2_sm_info_type_convertToJSON(sm_context_create_data->n2_sm_info_type_ext1);
        if (n2_sm_info_type_ext1_local_JSON == NULL) {
            ogs_error("OpenAPI_sm_context_create_data_convertToJSON() failed [n2_sm_info_type_ext1]");
            goto end;
        }
        cJSON_AddItemToObject(item, "n2SmInfoTypeExt1", n2_sm_info_type_ext1_local_JSON);
        if (item->child == NULL) {
            ogs_error("OpenAPI_sm_context_create_data_convertToJSON() failed [n2_sm_info_type_ext1]");
            goto end;
        }
    ...
    if (sm_context_create_data->extended_nas_sm_timer_ind >= 0) {
    ...
    if (sm_context_create_data->dl_data_waiting_ind >= 0) {
    ...
    if (sm_context_create_data->smf_transfer_ind >= 0) {
...
OpenAPI_sm_context_create_data_t *OpenAPI_sm_context_create_data_parseFromJSON(cJSON *sm_context_create_dataJSON)
{
    ...
    OpenAPI_n2_sm_info_type_t *n2_sm_info_type_local_nonprim = NULL;
    if (n2_sm_info_type) {
        n2_sm_info_type_local_nonprim = OpenAPI_n2_sm_info_type_parseFromJSON(n2_sm_info_type);
    }
    ...
    OpenAPI_n2_sm_info_type_t *n2_sm_info_type_ext1_local_nonprim = NULL;
    if (n2_sm_info_type_ext1) {
        n2_sm_info_type_ext1_local_nonprim = OpenAPI_n2_sm_info_type_parseFromJSON(n2_sm_info_type_ext1);
    }
    ...
    sm_context_create_data_local_var = OpenAPI_sm_context_create_data_create (
        ...
        indirect_forwarding_flag ? indirect_forwarding_flag->valueint : -1,
        ...
        smf_transfer_ind ? smf_transfer_ind->valueint : -1,
