...
{
    OpenAPI_session_management_subscription_data_t *session_management_subscription_data_local_var = OpenAPI_malloc(sizeof(OpenAPI_session_management_subscription_data_t));
    if (!session_management_subscription_data_local_var) {
        return NULL;
    }
...
cJSON *OpenAPI_session_management_subscription_data_convertToJSON(OpenAPI_session_management_subscription_data_t *session_management_subscription_data)
{
    ...
    if (session_management_subscription_data->internal_group_ids) {
        ...
        OpenAPI_list_for_each(session_management_subscription_data->internal_group_ids, internal_group_ids_node)  {
...
OpenAPI_session_management_subscription_data_t *OpenAPI_session_management_subscription_data_parseFromJSON(cJSON *session_management_subscription_dataJSON)
{
    ...
    cJSON *single_nssai = cJSON_GetObjectItemCaseSensitive(session_management_subscription_dataJSON, "singleNssai");
    if (!single_nssai) {
    ...
    cJSON *dnn_configurations = cJSON_GetObjectItemCaseSensitive(session_management_subscription_dataJSON, "dnnConfigurations");
